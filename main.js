...
const teamData = {
  teamPhotos: ["./img/team group/teamgroup_1.webp", null, null],
  ...
  members: [
    {
      ...
      role: "Survey Project",
      description:
        "عمل رفع مساحي للطريق وعمل القطاع الافقي للطريق وعمل بورتفوليو للمشروع.",
    ...
    },
    {
      ...
      role: "Survey Project",
      description:
        " تصميم القطاع الرأسي للطريق وتصميم الميل الطولي للمسار وتجهيز لوحات المشروع وشرح تنفيذ اعمال الطرق في الموقع واختبارات الصلاحية للموارد وعمل رفع مساحي للطريق.",
    ...
    },
    {
      ...
      role: "Survey Project",
      description:
        "عمل رفع مساحي للطريق وعمل القطاع الافقي للطريق وعمل كتاب للمشروع.",
    ...
    },
    {
      ...
      role: "Survey Project",
      description:
        "حساب كميات الحفر والردم للطريق وعمل تصميم مودلينج ونموذج محاكاة للواقع.",
    ...
    },
    {
      ...
      role: "Survey Project",
      description:
        "عمل رفع مساحي للطريق وعمل نموذج موديلينج للطريق بواسطة برنامج الارك برو.",
...
const bookRoll = [];
const totPages = 12;
const pagesContainer = document.querySelector("#swiperRoll");

function rollingPages() {
  for (let i = 1; i <= totPages; i++) {
    let page = {
      imgSrc: `./img/book/The-Book2025-${i}.webp`,
    };
    bookRoll.push(page);
  }
  let fragment = "";
  for (let i = 0; i < bookRoll.length; i++) {
    fragment += `<div class="swiper-slide">
                                <img src="${
                                  bookRoll[i].imgSrc
                                }" loading="lazy" alt="صفحة ${i + 1}">
                            </div>`;
  }
  pagesContainer.innerHTML = fragment;
}
rollingPages();
...
/* Render Members Cards inside Swiper */
function renderMembersSwiper() {
  ...
  teamData.members.forEach((member) => {
    ...
    for (let [platform, link] of Object.entries(member.social)) {
      socialHTML += `<a href="${link}" target="_blank"><i class='bx ${getSocialIcon(
        platform
      )}'></i></a>`;
    }
